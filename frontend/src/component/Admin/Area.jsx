                    ...
                    <tbody>
                        {area.map((item, index) => (
                            <tr key={index} className="text-center hover-table">
                                ...
                                <td className="align-middle px-3 text-start">{item?.city}</td>
                                <td className="align-middle px-3 text-start">{item?.state || '--N/A--'}</td>
                                <td className="align-middle px-3 text-start">{item?.country || '--N/A--'}</td>
