...
const AddCategory = () => {
  ...
  const handleAdd = async() =>{
    try{
      ...
      dispatch(showtoast({message:res.data.data.data.message,type:'success'}))
      console.log(res,'res')
      ...
      <Modal.Body>
        <Form>
          <Form.Group>
            ...
            <Form.Control placeholder='Enter Category Name' onChange={handleChange} name='cname' value={catdata.cname||""}/>
          </Form.Group>
