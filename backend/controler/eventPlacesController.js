...
const addPlace = async (req, res) => {
    try {
        ...
        const placefield = { title: place.title,
            price: place.price,
            rating: place.rating,
            price_per_plate: place.price_per_plate,
            guest_limit: place.guest_limit,
            ...
            status: place.status, 
            room_price: place.room_price, 
            total_rooms: place.total_rooms, 
        ...
        return res.status(200).json({ status: true, data: { message: 'Area added Successfully', data: dbplace } })
